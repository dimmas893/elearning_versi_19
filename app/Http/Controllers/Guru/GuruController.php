...
class GuruController extends Controller
{
    ...
    public function cari_ulangan_filter(Request $request, $id)
    {
        ...
        return view('frontend.guru.materi.cari_ulangan_filter', compact('cari_ulangan_filter', 'jadwal', 'semester'));
    }
    ...
    public function cari_ujian_filter(Request $request, $id)
    {
        $semester = Semester::all();
        $jadwal = Jadwal::with(['kelas'], ['guru'], ['mata_pelajaran'])->where('id', decrypt($id))->first();
        $cari_ujian_filter = DB::table('materi')
            ->select(
                'materi.judul as judul',
                'materi.type as type',
                'materi.file_or_link as file_or_link',
        ...
        return view('frontend.guru.materi.cari_ujian_filter', compact('cari_ujian_filter', 'jadwal', 'semester'));
    }
